...
export const workspaceChatbotKnowledge: ChatbotKnowledgeEntry[] = [
  ...
  { id: 34, question: "Why is Vault locked?", answer: "Vault is included with every current Exdox price. If access appears locked, refresh your session and check that your organisation's trial or subscription is active. Employees can use My Vault; business admins manage the company Vault." },
